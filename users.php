                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    ...
                                    <a href="Add_users.php" class="btn-box big span5"><i class="icon-plus"></i><img src="images/class.jpg"/></i><b>إضافة المستخدم</b></a>
                                 

								   <a href="update_users.php" class="btn-box big span5"><i class="icon-edit"></i><img src="images/class.jpg" /><b> إلغاء المستخدم</b></a>

                                </div>
								<?
								if($_SESSION['Flag_Add_user']==1)
								{
								?>
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert"><i class="icon-ok"></i></button>
										<strong>تم إضافة المستخدم</strong> إضافة المستخدم بنجاح :) 
									</div>
								<?
									
								}
								else if($_SESSION['Flag_Add_user']==-1)
								{
								?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>حدت خطاء !</strong>  أرجو إعادة إضافة و تاكد من بيانات المستخدم

									</div>
								<?
									$_SESSION['Flag_Add_user']=0;
								}
								?>
                            </div>
                        </div>
