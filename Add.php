                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    ...
                                    <a href="Add_Class.php" class="btn-box big span4"><i class="icon-plus"></i><img src="images/class.jpg"/></i><b>أضافة الصنف</b></a>
                                    <a href="delete_Class.php" class="btn-box big span4"><i class="icon-trash"></i><img src="images/class.jpg" /><b>إلغاء الصنف</b></a>
                                    <a href="edit_Class.php" class="btn-box big span4"><i class="icon-edit"></i><img src="images/class.jpg" /><b>تعديل الصنف</b></a>

                                </div>
								<?
								if($_SESSION['Flag_Add_Calss']==1)
								{
								?>
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert"><i class="icon-ok"></i></button>
										<strong>تم إضافة الصنف</strong> إضافة الصنف بنجاح :) 
									</div>
								<?
									
								}
								else if($_SESSION['Flag_Add_Calss']==-1)
								{
								?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>حدت خطاء !</strong>  أرجو إعادة إضافة و تاكد من بيانات الصنف

									</div>
								<?
									$_SESSION['Flag_Add_Calss']=0;
								}
								?>
                            </div>
                        </div>
